# File: src/train_model_volume.py
# This script trains an XGBoost classifier for the Volume strategy,
...
# -------------------------------
final_model.save_model(os.path.join(MODEL_DIR, 'xgboost_volume.json'))
...
with open(os.path.join(MODEL_DIR, 'volume_metadata.json'), 'w') as f:
