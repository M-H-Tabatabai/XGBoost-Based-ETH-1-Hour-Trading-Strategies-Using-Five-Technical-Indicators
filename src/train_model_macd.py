# File: src/train_model_macd.py
# This script trains an XGBoost classifier for the MACD strategy,
...
# -------------------------------
final_model.save_model(os.path.join(MODEL_DIR, 'xgboost_macd.json'))
...
with open(os.path.join(MODEL_DIR, 'macd_metadata.json'), 'w') as f:
