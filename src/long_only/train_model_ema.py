# File: src/train_model_ema.py
# This script trains an XGBoost classifier for the EMA strategy,
...
# -------------------------------
final_model.save_model(os.path.join(MODEL_DIR, 'xgboost_ema.json'))
...
with open(os.path.join(MODEL_DIR, 'ema_metadata.json'), 'w') as f:
